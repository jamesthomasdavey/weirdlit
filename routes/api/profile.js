  ...
  Profile.find({ handle: req.body.handle })
    .then(profile => {
      if (profile && profile.user !== req.user._id)
        ...
        if (req.body.social.goodreads) profile.social.goodreads = req.body.social.goodreads;
        if (req.body.social.facebook) profile.social.facebook = req.body.social.facebook;
        if (req.body.social.instagram) profile.social.instagram = req.body.social.instagram;
